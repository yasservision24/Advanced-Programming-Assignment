...
public class Reptile implements Animal {
    ...
    public Reptile() {
        ...
        addAnimal("Snake", "Hisss'sss", "Cold-blooded creature");
        addAnimal("Turtle", "None", "Slow-moving reptile");
    }
...
private String getKeyAtIndex(int index) {
    ...
    public void removeAnimal(int index) {
        if (animalDetails.size() > 2) {
            ...
            System.out.println("There must be at least two animals of the type Reptiles.");
        }
    }
