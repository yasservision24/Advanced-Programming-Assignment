...
public class Mammal implements Animal {
    ...
    public Mammal() {
        ...
        addAnimal("Lion", "Roars", "Majestic creature and the king of jungle");
        addAnimal("Elephant", "Trumpets", "Gentle giant of arfica");
    }
...
private String getKeyAtIndex(int index) {
    ...
    public void removeAnimal(int index) {
        if (animalDetails.size() > 2) {
            ...
            System.out.println("There must be at least two animals of type Mammal.");
        }
    }
